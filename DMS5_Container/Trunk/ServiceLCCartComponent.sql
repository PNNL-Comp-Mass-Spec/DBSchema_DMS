...
GO
GRANT EXECUTE ON [dbo].[ServiceLCCartComponent] TO [DMS2_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ServiceLCCartComponent] TO [Limited_Table_Write] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ServiceLCCartComponent] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[ServiceLCCartComponent] TO [PNL\D3M580] AS [dbo]
GO
