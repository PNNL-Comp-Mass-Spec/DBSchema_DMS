/****** Object:  View [dbo].[V_RequestArchiveUpdateTask] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW dbo.V_RequestArchiveUpdateTask
AS
SELECT     dbo.T_Dataset.Dataset_Num AS Dataset, dbo.T_Dataset.Dataset_ID AS DatasetID, dbo.T_Dataset.DS_folder_name AS DatasetFolder, 
                      ...
                      dbo.T_Archive_Path.AP_network_share_path AS ArchivePathSamba
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_RequestArchiveUpdateTask] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_RequestArchiveUpdateTask] TO [PNL\D3M580] AS [dbo]
GO
