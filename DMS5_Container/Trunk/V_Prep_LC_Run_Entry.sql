...
SELECT        ID, Tab, Instrument, Type, LC_Column AS LCColumn, LC_Column_2 AS LCColumn2, Comment, Guard_Column AS GuardColumn, Created, OperatorPRN, 
                         Digestion_Method AS DigestionMethod, Sample_Type AS SampleType, Number_Of_Runs AS NumberOfRuns, Instrument_Pressure AS InstrumentPressure, 
                         SamplePrepRequest, Quality_Control
FROM            T_Prep_LC_Run
GO
