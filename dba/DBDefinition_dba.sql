...
CREATE DATABASE [dba]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'dba', FILENAME = N'J:\SQLServerData\dba.mdf' , SIZE = 2068224KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'dba_log', FILENAME = N'H:\SQLServerData\dba_log.LDF' , SIZE = 492288KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB )
