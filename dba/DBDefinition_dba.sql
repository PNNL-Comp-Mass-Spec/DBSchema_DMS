...
CREATE DATABASE [dba]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'dba', FILENAME = N'J:\SQLServerData\dba.mdf' , SIZE = 2458112KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'dba_log', FILENAME = N'H:\SQLServerData\dba_log.LDF' , SIZE = 410368KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB )
 COLLATE SQL_Latin1_General_CP1_CI_AS
GO
ALTER DATABASE [dba] SET COMPATIBILITY_LEVEL = 120
GO
