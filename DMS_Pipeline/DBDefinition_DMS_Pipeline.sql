...
CREATE DATABASE [DMS_Pipeline]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS_Pipeline_T3', FILENAME = N'J:\SQLServerData\DMS_Pipeline.mdf' , SIZE = 13109312KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS_Pipeline_T3_log', FILENAME = N'K:\SQLServerData\DMS_Pipeline_log.ldf' , SIZE = 453760KB , MAXSIZE = 2048GB , FILEGROWTH = 131072KB )
