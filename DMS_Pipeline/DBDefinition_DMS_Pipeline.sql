...
CREATE DATABASE [DMS_Pipeline]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS_Pipeline_T3', FILENAME = N'J:\SQLServerData\DMS_Pipeline.mdf' , SIZE = 11895040KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS_Pipeline_T3_log', FILENAME = N'H:\SQLServerData\DMS_Pipeline_log.ldf' , SIZE = 486528KB , MAXSIZE = 2048GB , FILEGROWTH = 131072KB )
