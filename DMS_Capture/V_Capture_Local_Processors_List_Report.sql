...
SELECT processor_name, state, machine, manager_version,
       dbo.get_ctm_processor_step_tool_list(Processor_Name) AS tools,
       dbo.get_ctm_processor_assigned_instrument_list(Processor_Name) AS instruments, latest_request
