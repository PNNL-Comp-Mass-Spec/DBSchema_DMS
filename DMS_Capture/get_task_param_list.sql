/****** Object:  UserDefinedFunction [dbo].[get_task_param_list] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[get_task_param_list]
/****************************************************
**
**  Desc:
...
GO
GRANT VIEW DEFINITION ON [dbo].[get_task_param_list] TO [DDL_Viewer] AS [dbo]
GO
