/****** Object:  View [dbo].[V_DMS_Prep_LC_Job_Parameters] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE VIEW [dbo].[V_DMS_Prep_LC_Job_Parameters]
AS
SELECT TPR.id,
       TPR.instrument,
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_DMS_Prep_LC_Job_Parameters] TO [DDL_Viewer] AS [dbo]
GO
