...
CREATE DATABASE [DMS_Capture]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS_Capture', FILENAME = N'J:\SQLServerData\DMS_Capture.mdf' , SIZE = 5913536KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS_Capture_log', FILENAME = N'H:\SQLServerData\DMS_Capture_log.ldf' , SIZE = 2327808KB , MAXSIZE = 2048GB , FILEGROWTH = 131072KB )
 COLLATE SQL_Latin1_General_CP1_CI_AS
GO
ALTER DATABASE [DMS_Capture] SET COMPATIBILITY_LEVEL = 120
GO
