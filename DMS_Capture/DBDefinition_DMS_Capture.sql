...
CREATE DATABASE [DMS_Capture]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS_Capture', FILENAME = N'I:\SQLServerData\DMS_Capture.mdf' , SIZE = 4344512KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'DMS_Capture_log', FILENAME = N'H:\SQLServerData\DMS_Capture_log.ldf' , SIZE = 64896KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
