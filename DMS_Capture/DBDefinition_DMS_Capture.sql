...
( NAME = N'DMS_Capture', FILENAME = N'I:\SQLServerData\DMS_Capture.mdf' , SIZE = 5104128KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'DMS_Capture_log', FILENAME = N'H:\SQLServerData\DMS_Capture_log.ldf' , SIZE = 34176KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
