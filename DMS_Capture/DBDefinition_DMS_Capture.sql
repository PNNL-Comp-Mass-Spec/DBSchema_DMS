...
CREATE DATABASE [DMS_Capture]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS_Capture', FILENAME = N'J:\SQLServerData\DMS_Capture.mdf' , SIZE = 7216512KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS_Capture_log', FILENAME = N'H:\SQLServerData\DMS_Capture_log.ldf' , SIZE = 705792KB , MAXSIZE = 2048GB , FILEGROWTH = 131072KB )
...
GO
ALTER DATABASE [DMS_Capture] SET ANSI_NULL_DEFAULT OFF 
GO
...
GO
ALTER DATABASE [DMS_Capture] SET ALLOW_SNAPSHOT_ISOLATION ON 
GO
...
GO
ALTER DATABASE [DMS_Capture] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [DMS_Capture] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [DMS_Capture] SET DELAYED_DURABILITY = DISABLED 
GO
USE [DMS_Capture]
GO
...
GO
ALTER DATABASE [DMS_Capture] SET  READ_ONLY 
GO
