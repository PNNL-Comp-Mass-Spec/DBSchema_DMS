...
AS
SELECT Dataset_Num, DS_created, IN_name, DSS_name, DS_comment, DS_folder_name, 
       SP_path, SP_vol_name_server, SP_vol_name_client, DST_name, 
       DS_sec_sep, LC_Cart_Name, LC_Cart_Config, LC_Column, DS_Well_num, 
       DS_Oper_PRN, Dataset_ID, Experiment_Num, EX_Reason, EX_organism_name, EX_cell_culture_list, 
