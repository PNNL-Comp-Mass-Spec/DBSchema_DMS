...
CREATE DATABASE [Ontology_Lookup]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Ontology_Lookup', FILENAME = N'J:\SQLServerData\Ontology_Lookup.mdf' , SIZE = 8882752KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'Ontology_Lookup_log', FILENAME = N'H:\SQLServerData\Ontology_Lookup_log.ldf' , SIZE = 289600KB , MAXSIZE = 2048GB , FILEGROWTH = 131072KB )
