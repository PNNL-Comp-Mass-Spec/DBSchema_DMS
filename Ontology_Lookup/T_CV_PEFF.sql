/****** Object:  Table [dbo].[T_CV_PEFF] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_CV_PEFF](
 ...
 CONSTRAINT [PK_T_CV_PEFF] PRIMARY KEY CLUSTERED 
(
	[Entry_ID] ASC
...
GO
ALTER TABLE [dbo].[T_CV_PEFF] ADD  CONSTRAINT [DF_T_CV_PEFF_Entered]  DEFAULT (getdate()) FOR [Entered]
GO
ALTER TABLE [dbo].[T_CV_PEFF] ADD  CONSTRAINT [DF_T_CV_PEFF_Updated]  DEFAULT (getdate()) FOR [Updated]
GO
