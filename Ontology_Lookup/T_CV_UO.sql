/****** Object:  Table [dbo].[T_CV_UO] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[T_CV_UO](
...
GO
ALTER TABLE [dbo].[T_CV_UO] ADD  CONSTRAINT [DF_T_CV_UO_Entered]  DEFAULT (getdate()) FOR [Entered]
GO
ALTER TABLE [dbo].[T_CV_UO] ADD  CONSTRAINT [DF_T_CV_UO_Updated]  DEFAULT (getdate()) FOR [Updated]
GO
