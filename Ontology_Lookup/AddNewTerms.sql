...
AS
	...
	Begin
		...
		--
		Set @InsertSql = ' INSERT INTO ' + @TargetTable + ' ( Term_Name, identifier, Is_Leaf, Parent_term_name, Parent_term_ID,  GrandParent_term_name,  GrandParent_term_ID )'
		Set @S = ''
		Set @S = @S + ' SELECT DISTINCT term_name, identifier, is_leaf, Parent_term_name, Parent_term_Identifier, GrandParent_term_name, GrandParent_term_Identifier'
