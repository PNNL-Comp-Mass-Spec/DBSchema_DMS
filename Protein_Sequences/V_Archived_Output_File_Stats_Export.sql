...
SELECT AOF.Archived_File_ID,
       ...
       dbo.get_file_name_from_path(AOF.Archived_File_Path) AS Archived_File_Name
...
GROUP BY AOF.Archived_File_ID, AOF.Filesize, dbo.get_file_name_from_path(AOF.Archived_File_Path)
