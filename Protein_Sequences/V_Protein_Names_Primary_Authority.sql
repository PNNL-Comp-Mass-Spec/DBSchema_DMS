/****** Object:  View [dbo].[V_Protein_Names_Primary_Authority] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW dbo.V_Protein_Names_Primary_Authority
AS
SELECT     dbo.T_Protein_Names.Name, dbo.T_Protein_Collection_Members.Protein_ID, dbo.T_Protein_Names.Annotation_Type_ID, 
