...
SELECT PCByOrg.FileName AS Name,
       ...
       AOF.Filesize,
       PCByOrg.Organism_ID
FROM dbo.V_Protein_Collections_By_Organism AS PCByOrg
     INNER JOIN dbo.T_Protein_Collection_Types AS PCTypes
       ON PCByOrg.Collection_Type_ID = PCTypes.Collection_Type_ID
