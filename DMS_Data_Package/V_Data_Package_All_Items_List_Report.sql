...
UNION
SELECT Data_Pkg_ID AS id,
       '<item pkg="' + CONVERT(varchar(12), Data_Pkg_ID) + '" type="Dataset" id="' + Dataset + '"/>' AS sel,
...
UNION
SELECT Data_Pkg_ID AS id,
       '<item pkg="' + CONVERT(varchar(12), Data_Pkg_ID) + '" type="Experiment" id="' + Experiment + '"/>' AS sel,
...
UNION
SELECT Data_Pkg_ID AS id,
       '<item pkg="' + CONVERT(varchar(12), Data_Pkg_ID) + '" type="Biomaterial" id="' + Name + '"/>' AS sel,
