/****** Object:  StoredProcedure [dbo].[regenerate_data_package_folder_name] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[regenerate_data_package_folder_name]
/****************************************************
**
...
AS
    ...
    Set @NewDataPackageFolder = dbo.make_package_folder_name(@DataPkgID, @DataPackageName)

    If @UpdateWikiLink = 0
        Set @NewDataPackageWiki = @CurrentDataPackageWiki
    Else
        Set @NewDataPackageWiki = dbo.make_prismwiki_page_link(@DataPkgID, @DataPackageName)
...
GO
GRANT VIEW DEFINITION ON [dbo].[regenerate_data_package_folder_name] TO [DDL_Viewer] AS [dbo]
GO
