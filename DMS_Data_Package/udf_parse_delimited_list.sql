/****** Object:  UserDefinedFunction [dbo].[udf_parse_delimited_list] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[udf_parse_delimited_list]
/****************************************************
...
GO
GRANT VIEW DEFINITION ON [dbo].[udf_parse_delimited_list] TO [DDL_Viewer] AS [dbo]
GO
