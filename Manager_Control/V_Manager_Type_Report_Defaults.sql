/****** Object:  View [dbo].[V_Manager_Type_Report_Defaults] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[V_Manager_Type_Report_Defaults]
AS
SELECT     MT.MT_TypeName AS [Manager Type], MT.MT_TypeID AS ID, ISNULL(ActiveManagersQ.ManagerCountActive, 0) AS [Manager Count Active], 
                      ISNULL(ActiveManagersQ.ManagerCountInactive, 0) AS [Manager Count Inactive]
FROM         dbo.T_MgrTypes AS MT LEFT OUTER JOIN
