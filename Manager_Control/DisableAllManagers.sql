/****** Object:  StoredProcedure [dbo].[DisableAllManagers] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE dbo.DisableAllManagers
/****************************************************
** 
**	Desc:	Disables all managers
**
...
As
	...
	-----------------------------------------------
	-- Loop through the manager types in T_MgrTypes
	...
	Begin
		...
		Else
		Begin
			exec @myError = EnableDisableManagers @Enable=0, @ManagerTypeID=@MgrTypeID, @ManagerNameList=@ManagerNameList, @PreviewUpdates = @PreviewUpdates, @message = @message output
		End		
	End
...
GO
GRANT EXECUTE ON [dbo].[DisableAllManagers] TO [DMSWebUser] AS [dbo]
GO
