...
SELECT dbo.T_Experiments.Experiment_Num AS experiment,
       COUNT(dbo.T_Dataset.Dataset_ID) AS datasets,
...
FROM dbo.T_Campaign
     INNER JOIN dbo.T_Experiments
       ON dbo.T_Campaign.Campaign_ID = dbo.T_Experiments.EX_campaign_ID
     INNER JOIN dbo.T_Dataset
       ON dbo.T_Experiments.Exp_ID = dbo.T_Dataset.Exp_ID
GROUP BY dbo.T_Campaign.Campaign_Num, dbo.T_Experiments.Experiment_Num, dbo.T_Experiments.EX_reason,
         dbo.T_Experiments.EX_created
