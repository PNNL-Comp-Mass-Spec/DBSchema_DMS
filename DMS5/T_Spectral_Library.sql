...
GO
/****** Object:  Index [IX_T_Spectral_Library_Library_Name_Settings_Hash] ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_T_Spectral_Library_Library_Name_Settings_Hash] ON [dbo].[T_Spectral_Library]
(
	[Library_Name] ASC,
	[Settings_Hash] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
