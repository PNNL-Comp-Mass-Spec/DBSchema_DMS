...
/****************************************************
** 
**	Desc:	Updates #TmpParamFileInfo to include some
**			 additional Sequest-specific columns.
**			Returns the list of columns added using 
**			 parameter @ParamFileInfoColumnList
**		
