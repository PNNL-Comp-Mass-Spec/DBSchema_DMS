...
GO
-- 
CREATE VIEW  V_Experiment_Groups_Detail_Report AS 
...
FROM    dbo.T_Experiment_Groups AS EG
        LEFT OUTER JOIN dbo.T_Experiment_Group_Members AS EGM ON EG.Group_ID = EGM.Group_ID
        INNER JOIN dbo.T_Experiments AS E ON EG.Parent_Exp_ID = E.Exp_ID
        LEFT OUTER JOIN dbo.T_Users AS U ON EG.Researcher = U.U_PRN
