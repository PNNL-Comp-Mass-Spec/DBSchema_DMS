/****** Object:  View [dbo].[V_Filter_Set_Criteria_Crosstab2] ******/
SET ANSI_NULLS ON
GO
...
FROM ( SELECT Filter_Set_ID,
                   ...
                   Filter_Criteria_Group_ID,
                   Criterion_Name,
                   Criterion_Comparison + ' ' + Convert(varchar(12), Criterion_Value) as Criterion
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_Filter_Set_Criteria_Crosstab2] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_Filter_Set_Criteria_Crosstab2] TO [PNL\D3M580] AS [dbo]
GO
