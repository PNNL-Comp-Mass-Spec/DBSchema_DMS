/****** Object:  StoredProcedure [dbo].[add_update_bionet_host] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[add_update_bionet_host]
/****************************************************
**
...
AS
    ...
    Exec @authorized = verify_sp_authorized 'add_update_bionet_host', @raiseError = 1
    If @authorized = 0
    Begin;
    ...
    Begin Catch
        ...
        If @logErrors > 0
        Begin
            Exec post_log_entry 'Error', @message, 'add_update_bionet_host'
        End
...
GO
GRANT VIEW DEFINITION ON [dbo].[add_update_bionet_host] TO [DDL_Viewer] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[add_update_bionet_host] TO [DMS2_SP_User] AS [dbo]
GO
