...
**          11/25/2014 mem - Now using dbo.append_to_text() to avoid appending duplicate text
...
AS
    ...
    Begin
        ...
        Begin
            ...
            UPDATE T_Dataset
            SET DS_comment = dbo.append_to_text(DS_Comment, @comment, 0, '; ', 512),
                DS_state_ID = 4,
                DS_rating = -1
            WHERE Dataset_ID = @datasetID
            --
            ...
            Begin
                ...
                Exec add_archive_dataset @datasetID
