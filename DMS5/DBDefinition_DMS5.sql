...
CREATE DATABASE [DMS5]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS4_dat', FILENAME = N'I:\SQLServerData\DMS5.mdf' , SIZE = 21549952KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'DMS4_log', FILENAME = N'H:\SQLServerData\DMS5_log.ldf' , SIZE = 21312KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
