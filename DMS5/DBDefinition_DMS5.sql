...
CREATE DATABASE [DMS5]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS4_dat', FILENAME = N'J:\SQLServerData\DMS5.mdf' , SIZE = 5824000KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS4_log', FILENAME = N'H:\SQLServerData\DMS5_log.ldf' , SIZE = 1345024KB , MAXSIZE = UNLIMITED, FILEGROWTH = 131072KB )
