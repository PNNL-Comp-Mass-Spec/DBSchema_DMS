...
( NAME = N'DMS4_dat', FILENAME = N'J:\SQLServerData\DMS5.mdf' , SIZE = 6086144KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS4_log', FILENAME = N'H:\SQLServerData\DMS5_log.ldf' , SIZE = 656896KB , MAXSIZE = UNLIMITED, FILEGROWTH = 131072KB )
 COLLATE SQL_Latin1_General_CP1_CI_AS
GO
ALTER DATABASE [DMS5] SET COMPATIBILITY_LEVEL = 120
GO
...
GO
ALTER DATABASE [DMS5] SET DELAYED_DURABILITY = DISABLED 
GO
USE [DMS5]
GO
/****** Object:  User [D3L243] ******/
