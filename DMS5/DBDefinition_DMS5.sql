...
CREATE DATABASE [DMS5]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS4_dat', FILENAME = N'J:\SQLServerData\DMS5.mdf' , SIZE = 11427648KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS4_log', FILENAME = N'H:\SQLServerData\DMS5_log.ldf' , SIZE = 296192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 131072KB )
...
GO
ALTER DATABASE [DMS5] SET ALLOW_SNAPSHOT_ISOLATION ON 
GO
...
GO
ALTER DATABASE [DMS5] SET  READ_ONLY 
GO
