...
CREATE DATABASE [DMS5]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DMS4_dat', FILENAME = N'J:\SQLServerData\DMS5.mdf' , SIZE = 8969728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 262144KB )
 LOG ON 
( NAME = N'DMS4_log', FILENAME = N'H:\SQLServerData\DMS5_log.ldf' , SIZE = 148736KB , MAXSIZE = UNLIMITED, FILEGROWTH = 131072KB )
