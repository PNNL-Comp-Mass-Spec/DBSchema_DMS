/****** Object:  View [dbo].[V_Experiment_Export] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[V_Experiment_Export]
AS
SELECT E.Exp_ID AS experiment_id,
       ...
       E.EX_sample_prep_request_ID AS sample_prep_request_id,
       MC.Tag AS container,
       ML.Tag AS location,
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_Experiment_Export] TO [DDL_Viewer] AS [dbo]
GO
