...
GO
CREATE PROCEDURE [dbo].[RefreshCachedMTDBs]
/****************************************************
**
...
AS
    ...
    Begin Try
        ...
        begin
            ...
            execute PostLogEntry 'Error', @message, 'RefreshCachedMTDBs'
            goto Done
        end
...
GO
GRANT VIEW DEFINITION ON [dbo].[RefreshCachedMTDBs] TO [DDL_Viewer] AS [dbo]
GO
