...
SELECT TOP 100 PERCENT dbo.T_AuxInfo_Target.Name AS Target, 
   ...
   dbo.T_AuxInfo_Value.Value, 
   dbo.T_AuxInfo_Category.Sequence AS SC, 
   dbo.T_AuxInfo_Subcategory.Sequence AS SS, 
   dbo.T_AuxInfo_Description.Sequence AS SI, 
...
FROM dbo.T_AuxInfo_Category INNER JOIN
   ...
   dbo.T_AuxInfo_Subcategory.ID = dbo.T_AuxInfo_Description.Parent_ID
    INNER JOIN
   dbo.T_AuxInfo_Value ON 
   dbo.T_AuxInfo_Description.ID = dbo.T_AuxInfo_Value.AuxInfo_ID INNER
    JOIN
