...
AS
    ...
    ----------------------------------------------------------
    -- Update sample submission statistics for results table
    ----------------------------------------------------------
    --
    UPDATE T
    SET
        Sample_Submission_Count = S.Cnt,
    ...
    INNER JOIN (
        ...
        FROM
            T_Campaign
            INNER JOIN T_Sample_Submission ON T_Campaign.Campaign_ID = T_Sample_Submission.Campaign_ID
        GROUP BY
            T_Campaign.Campaign_ID
    ) AS S ON T.C_ID = S.Campaign_ID     
          
    ----------------------------------------------------------
    -- Update cell culture statistics for results table
    ----------------------------------------------------------
    --
    UPDATE T
    SET
    ...
    ----------------------------------------------------------
    -- Update experiment statistics for results table
    ----------------------------------------------------------
    --
    UPDATE T
    SET
    ...
    ----------------------------------------------------------
    -- Update dataset statistics for results table
    ----------------------------------------------------------
    --
    UPDATE T
    SET
    ...
    ----------------------------------------------------------
    -- Update analysis statistics for results table
    ----------------------------------------------------------
    --
    UPDATE T
    SET 
    ...
    ----------------------------------------------------------
    -- Update requested run statistics for results table
    ----------------------------------------------------------
    --
    UPDATE
      T_Campaign_Tracking
    ...
    ----------------------------------------------------------
    -- Update sample prep statistics for results table
    ----------------------------------------------------------
    --
    UPDATE
      T_Campaign_Tracking
