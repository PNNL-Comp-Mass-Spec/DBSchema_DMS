...
/****************************************************
** 
**	Desc:	Updates the settings file name and parameter file name
...
As
	...
	Set @requestMinimum = IsNull(@requestMinimum, 0)
	Set @recentRequestDays = IsNull(@recentRequestDays, 14)
	...
	Begin
		...
		Set @requestMinimum = IsNull(@requestMinimum, 2)
	End
	...
	FROM ( SELECT AJ_requestID,
	        ...
	        WHERE AJ_requestID >= @requestMinimum AND
	            NOT AJ_settingsFileName Is Null AND 
	            NOT AJ_parmFileName Is Null
