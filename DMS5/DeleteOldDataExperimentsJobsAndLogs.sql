...
AS
    ...
    -- For added safety, Goto Done is included here for added safety
    ...
    Declare @DeleteThreshold Datetime = DateAdd(year, -@YearsToRetain, GetDate())

    Declare @JobKeepThreshold datetime = DateAdd(day, -@RecentJobOverrideYears*365, GetDate())

    Declare @LogDeleteThreshold datetime = DateAdd(month, -@LogEntryMonthsToRetain, GetDate())
