...
GROUP BY T_Cell_Culture.CC_Name
         , T_Experiments.Experiment_Num, T_Experiments.EX_reason, T_Experiments.EX_created


GO
GRANT VIEW DEFINITION ON [dbo].[V_Cell_Culture_Experiment_Tracking] TO [DDL_Viewer] AS [dbo]
GO
