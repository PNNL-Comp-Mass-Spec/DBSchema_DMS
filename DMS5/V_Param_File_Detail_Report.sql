...
SELECT PF.Param_File_ID AS id,
       ...
       dbo.combine_paths(Tool.ajt_parmfilestoragepath, PF.Param_File_Name) AS file_path,
       PF.valid,
       dbo.get_param_file_mass_mods_table_code(PF.Param_File_ID) AS mass_mods,
       dbo.get_maxquant_mass_mods_list(PF.Param_File_ID) AS maxquant_mods,
       PF.Mod_List As mod_code_list,
       dbo.get_param_file_mass_mod_code_list(PF.param_file_id, 1) As mod_codes_with_symbols
