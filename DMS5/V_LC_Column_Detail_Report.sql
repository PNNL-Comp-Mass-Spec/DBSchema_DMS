/****** Object:  View [dbo].[V_LC_Column_Detail_Report] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE VIEW dbo.V_LC_Column_Detail_Report
AS
SELECT     T_LC_Column.SC_Column_Number AS [Column Number], T_LC_Column_State_Name.LCS_Name AS State, T_LC_Column.SC_Created AS Created, 
                      ...
                      T_LC_Column.SC_Comment AS Comment, T_LC_Column.ID
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_LC_Column_Detail_Report] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_LC_Column_Detail_Report] TO [PNL\D3M580] AS [dbo]
GO
