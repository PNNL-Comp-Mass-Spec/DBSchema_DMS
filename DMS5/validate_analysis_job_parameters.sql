...
**          03/27/2023 mem - Add logic for tool DiaNN
**
*****************************************************/
(
    @toolName varchar(64),
...
AS
    ...
    Begin
        ...
        End
        Else If @mode = 'reset' And (@toolName LIKE 'MAC[_]%' Or @toolName = 'MaxQuant_DataPkg' Or @toolName = 'MSFragger_DataPkg' Or @toolName = 'DiaNN_DataPkg')
        Begin
