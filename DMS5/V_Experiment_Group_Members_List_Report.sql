...
GO
create VIEW V_Experiment_Group_Members_List_Report
AS
SELECT     dbo.T_Experiments.Experiment_Num AS Experiment, 
                      ...
                      dbo.T_Experiments.EX_researcher_PRN AS Researcher, dbo.T_Experiments.EX_organism_name AS Organism, 
                      dbo.T_Experiments.EX_reason AS Reason, dbo.T_Experiments.EX_comment AS Comment, dbo.T_Experiment_Groups.Group_ID AS [#Group]
FROM         dbo.T_Experiments INNER JOIN
                      ...
                      dbo.T_Experiment_Group_Members ON dbo.T_Experiments.Exp_ID = dbo.T_Experiment_Group_Members.Exp_ID LEFT OUTER JOIN
