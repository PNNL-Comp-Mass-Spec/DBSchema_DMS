...
FROM dbo.T_Analysis_Job_Processor_Group_Associations AJPGA
     INNER JOIN dbo.T_Analysis_Job_Processor_Group AJPG
       ON AJPGA.Group_ID = AJPG.ID
     RIGHT OUTER JOIN ( SELECT AJ.AJ_batchID,
                               AJ.AJ_jobID,
                               DS.Dataset_Num,
                               AJ.AJ_priority,
                               AJ.AJ_StateID,
