/****** Object:  View [dbo].[V_EUS_Export_Job_Metadata] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE VIEW [dbo].[V_EUS_Export_Job_Metadata]
AS
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_EUS_Export_Job_Metadata] TO [DDL_Viewer] AS [dbo]
GO
