/****** Object:  StoredProcedure [dbo].[update_analysis_job_processor_group_associations] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[update_analysis_job_processor_group_associations]
/****************************************************
**
**  Desc:
...
*/
    ...
    Begin
        -- Call alter_entered_by_user for each processor job in #TAJ
    ...
    Exec post_usage_log_entry 'update_analysis_job_processor_group_associations', @UsageMessage

    return @myError

GO
GRANT VIEW DEFINITION ON [dbo].[update_analysis_job_processor_group_associations] TO [DDL_Viewer] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[update_analysis_job_processor_group_associations] TO [DMS_Analysis] AS [dbo]
GO
GRANT EXECUTE ON [dbo].[update_analysis_job_processor_group_associations] TO [DMS2_SP_User] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[update_analysis_job_processor_group_associations] TO [Limited_Table_Write] AS [dbo]
GO
