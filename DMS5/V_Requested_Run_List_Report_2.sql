...
GO
CREATE view V_Requested_Run_List_Report_2 as
SELECT     RR.ID AS Request, RR.RDS_Name AS Name, RR.RDS_Status AS Status, RR.RDS_Origin AS Origin, RR.RDS_priority AS Pri, ISNULL(DS.Acq_Time_Start, 
                      ...
                      DTN.DST_name AS Type, RR.RDS_Sec_Sep AS [Separation Type], RR.RDS_Well_Plate_Num AS Wellplate, RR.RDS_Well_Num AS Well, RR.RDS_Block AS Block, 
