...
FROM T_Event_Log EL
     ...
     INNER JOIN T_Archive_Update_State_Name S1
       ON EL.Target_State = S1.AUS_stateID
     INNER JOIN T_Archive_Update_State_Name T_Archive_Update_State_Name
       ON EL.Prev_Target_State = T_Archive_Update_State_Name.AUS_stateID
