...
GO
CREATE VIEW V_Storage_List_Report
AS
SELECT     dbo.t_storage_path.SP_path_ID AS ID, dbo.t_storage_path.SP_path AS Path, dbo.t_storage_path.SP_vol_name_client AS [Vol Client], 
                      ...
                      dbo.t_storage_path.SP_instrument_name AS Instrument, dbo.t_storage_path.SP_descripton AS Description, COUNT(dbo.T_Dataset.Dataset_ID) 
                      AS Datasets
...
GROUP BY dbo.t_storage_path.SP_path_ID, dbo.t_storage_path.SP_path, dbo.t_storage_path.SP_vol_name_client, dbo.t_storage_path.SP_vol_name_server, 
                      dbo.t_storage_path.SP_function, dbo.t_storage_path.SP_instrument_name, dbo.t_storage_path.SP_descripton
