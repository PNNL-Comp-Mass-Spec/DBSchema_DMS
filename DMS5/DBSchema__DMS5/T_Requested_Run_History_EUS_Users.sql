...
GO
ALTER TABLE [dbo].[T_Requested_Run_History_EUS_Users]  WITH CHECK ADD  CONSTRAINT [FK_T_Requested_Run_History_EUS_Users_T_EUS_Site_Status] FOREIGN KEY([Site_Status])
REFERENCES [T_EUS_Site_Status] ([ID])
GO
ALTER TABLE [dbo].[T_Requested_Run_History_EUS_Users]  WITH CHECK ADD  CONSTRAINT [FK_T_Requested_Run_History_EUS_Users_T_EUS_Users] FOREIGN KEY([EUS_Person_ID])
