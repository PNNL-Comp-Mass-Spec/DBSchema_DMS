...
INSERT INTO [T_MiscPaths] (path_id, [Function], Server, Client, Comment) VALUES (5,'DIMTriggerFileDir','G:\DIM_Trigger\','\\gigasax\DIM_Trigger','Deprecated in October 2023 since table T_Dataset_Trigger_File_Create_Queue is now used to track datasets created using the website')
