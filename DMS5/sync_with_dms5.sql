/****** Object:  StoredProcedure [dbo].[sync_with_dms5] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sync_with_dms5]
/****************************************************
**
...
**          10/29/2015 mem - Now passing @tableName to sync_with_dms_show_stats
...
AS
    ...
    Set @yearsToCopy = Coalesce(@YearsToCopy, 4)
    If @yearsToCopy < 1
        Set @yearsToCopy = 1
    ...
    Set @DeleteExtras = Coalesce(@DeleteExtras, 1)
    Set @ShowUpdateDetails = Coalesce(@ShowUpdateDetails, 0)
    Set @instruments = Coalesce(@instruments, 1)
    Set @parameters = Coalesce(@parameters, 1)
    Set @usersAndCampaigns = Coalesce(@usersAndCampaigns, 1)
    Set @chargeCodesAndEUS = Coalesce(@chargeCodesAndEUS, 1)
    Set @experiments = Coalesce(@experiments, 0)
    Set @datasets = Coalesce(@datasets, 0)
    Set @jobs = Coalesce(@jobs, 0)
    ...
    Begin -- <Instruments>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[x_Allowed_Dataset_Types], s.[x_Allowed_Dataset_Types]),
                ...
                Coalesce(Cast(t.[Params] AS varchar(max)), '') <>    Coalesce(Cast(s.[Params] AS varchar(max)), '')
                )
            THEN UPDATE SET
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[DST_Description], s.[DST_Description]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Usage], s.[Usage]),
                        NULLIF(s.[Usage], t.[Usage])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Comment], s.[Comment]),
                        NULLIF(s.[Comment], t.[Comment])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Default_Dataset_Type], s.[Default_Dataset_Type]),
                        NULLIF(s.[Default_Dataset_Type], t.[Default_Dataset_Type])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Allocation_Tag], s.[Allocation_Tag]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[SP_machine_name], s.[SP_machine_name]),
                        NULLIF(s.[SP_machine_name], t.[SP_machine_name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SP_vol_name_client], s.[SP_vol_name_client]),
                        NULLIF(s.[SP_vol_name_client], t.[SP_vol_name_client])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SP_vol_name_server], s.[SP_vol_name_server]),
                        NULLIF(s.[SP_vol_name_server], t.[SP_vol_name_server])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SP_instrument_name], s.[SP_instrument_name]),
                        NULLIF(s.[SP_instrument_name], t.[SP_instrument_name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SP_code], s.[SP_code]),
                        NULLIF(s.[SP_code], t.[SP_code])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SP_description], s.[SP_description]),
                        NULLIF(s.[SP_description], t.[SP_description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SP_created], s.[SP_created]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[IN_source_path_ID], s.[IN_source_path_ID]),
                        NULLIF(s.[IN_source_path_ID], t.[IN_source_path_ID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[IN_storage_path_ID], s.[IN_storage_path_ID]),
                        NULLIF(s.[IN_storage_path_ID], t.[IN_storage_path_ID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[IN_capture_method], s.[IN_capture_method]),
                        NULLIF(s.[IN_capture_method], t.[IN_capture_method])) IS NOT NULL OR
                Coalesce( NULLIF(t.[IN_status], s.[IN_status]),
                        NULLIF(s.[IN_status], t.[IN_status])) IS NOT NULL OR
                Coalesce( NULLIF(t.[IN_Room_Number], s.[IN_Room_Number]),
                        NULLIF(s.[IN_Room_Number], t.[IN_Room_Number])) IS NOT NULL OR
                Coalesce( NULLIF(t.[IN_Description], s.[IN_Description]),
                        NULLIF(s.[IN_Description], t.[IN_Description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[IN_Created], s.[IN_Created]),
                        NULLIF(s.[IN_Created], t.[IN_Created])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_Vol_Name_Client], s.[Auto_SP_Vol_Name_Client]),
                        NULLIF(s.[Auto_SP_Vol_Name_Client], t.[Auto_SP_Vol_Name_Client])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_Vol_Name_Server], s.[Auto_SP_Vol_Name_Server]),
                        NULLIF(s.[Auto_SP_Vol_Name_Server], t.[Auto_SP_Vol_Name_Server])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_Path_Root], s.[Auto_SP_Path_Root]),
                        NULLIF(s.[Auto_SP_Path_Root], t.[Auto_SP_Path_Root])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_URL_Domain], s.[Auto_SP_URL_Domain]),
                        NULLIF(s.[Auto_SP_URL_Domain], t.[Auto_SP_URL_Domain])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_Archive_Server_Name], s.[Auto_SP_Archive_Server_Name]),
                        NULLIF(s.[Auto_SP_Archive_Server_Name], t.[Auto_SP_Archive_Server_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_Archive_Path_Root], s.[Auto_SP_Archive_Path_Root]),
                        NULLIF(s.[Auto_SP_Archive_Path_Root], t.[Auto_SP_Archive_Path_Root])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Auto_SP_Archive_Share_Path_Root], s.[Auto_SP_Archive_Share_Path_Root]),
    ...
    Begin -- <Parameters>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                Coalesce( NULLIF(t.[Param_File_Type], s.[Param_File_Type]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[AJT_paramFileType], s.[AJT_paramFileType]),
                        NULLIF(s.[AJT_paramFileType], t.[AJT_paramFileType])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_parmFileStoragePath], s.[AJT_parmFileStoragePath]),
                        NULLIF(s.[AJT_parmFileStoragePath], t.[AJT_parmFileStoragePath])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_parmFileStoragePathLocal], s.[AJT_parmFileStoragePathLocal]),
                        NULLIF(s.[AJT_parmFileStoragePathLocal], t.[AJT_parmFileStoragePathLocal])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_defaultSettingsFileName], s.[AJT_defaultSettingsFileName]),
                        NULLIF(s.[AJT_defaultSettingsFileName], t.[AJT_defaultSettingsFileName])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_resultType], s.[AJT_resultType]),
                        NULLIF(s.[AJT_resultType], t.[AJT_resultType])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_autoScanFolderFlag], s.[AJT_autoScanFolderFlag]),
                        NULLIF(s.[AJT_autoScanFolderFlag], t.[AJT_autoScanFolderFlag])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_searchEngineInputFileFormats], s.[AJT_searchEngineInputFileFormats]),
                        NULLIF(s.[AJT_searchEngineInputFileFormats], t.[AJT_searchEngineInputFileFormats])) IS NOT NULL OR
                Coalesce( NULLIF(t.[x_Unused_AJT_toolTag], s.[x_Unused_AJT_toolTag]),
                        NULLIF(s.[x_Unused_AJT_toolTag], t.[x_Unused_AJT_toolTag])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJT_description], s.[AJT_description]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                t.[Valid] <> s.[Valid] OR
                Coalesce( NULLIF(t.[Param_File_Description], s.[Param_File_Description]),
                        NULLIF(s.[Param_File_Description], t.[Param_File_Description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Date_Created], s.[Date_Created]),
                        NULLIF(s.[Date_Created], t.[Date_Created])) IS NOT NULL OR
                -- Ignore: Coalesce( NULLIF(t.[Date_Modified], s.[Date_Modified]),
                --                 NULLIF(s.[Date_Modified], t.[Date_Modified])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Job_Usage_Count], s.[Job_Usage_Count]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Entry_Sequence_Order], s.[Entry_Sequence_Order]),
                        NULLIF(s.[Entry_Sequence_Order], t.[Entry_Sequence_Order])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Entry_Type], s.[Entry_Type]),
                        NULLIF(s.[Entry_Type], t.[Entry_Type])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Entry_Specifier], s.[Entry_Specifier]),
                        NULLIF(s.[Entry_Specifier], t.[Entry_Specifier])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Entry_Value], s.[Entry_Value]),
                        NULLIF(s.[Entry_Value], t.[Entry_Value])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Entered], s.[Entered]),
                        NULLIF(s.[Entered], t.[Entered])) IS NOT NULL
                -- Ignore: Coalesce( NULLIF(t.[Entered_By], s.[Entered_By]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Average_Mass], s.[Average_Mass]),
                        NULLIF(s.[Average_Mass], t.[Average_Mass])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Original_Source], s.[Original_Source]),
                        NULLIF(s.[Original_Source], t.[Original_Source])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Original_Source_Name], s.[Original_Source_Name]),
                        NULLIF(s.[Original_Source_Name], t.[Original_Source_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Alternative_Name], s.[Alternative_Name]),
                        NULLIF(s.[Alternative_Name], t.[Alternative_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Empirical_Formula], s.[Empirical_Formula]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Residue_ID], s.[Residue_ID]),
                        NULLIF(s.[Residue_ID], t.[Residue_ID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Param_File_ID], s.[Param_File_ID]),
                        NULLIF(s.[Param_File_ID], t.[Param_File_ID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Mod_Type_Symbol], s.[Mod_Type_Symbol]),
    ...
    Begin -- <UsersAndCampaigns>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[U_email], s.[U_email]),
                        NULLIF(s.[U_email], t.[U_email])) IS NOT NULL OR
                Coalesce( NULLIF(t.[U_domain], s.[U_domain]),
                        NULLIF(s.[U_domain], t.[U_domain])) IS NOT NULL OR
                Coalesce( NULLIF(t.[U_Payroll], s.[U_Payroll]),
                        NULLIF(s.[U_Payroll], t.[U_Payroll])) IS NOT NULL OR
                Coalesce( NULLIF(t.[U_created], s.[U_created]),
                        NULLIF(s.[U_created], t.[U_created])) IS NOT NULL OR
                Coalesce( NULLIF(t.[U_comment], s.[U_comment]),
                        NULLIF(s.[U_comment], t.[U_comment])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Last_Affected], s.[Last_Affected]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Description], s.[Description]),
                        NULLIF(s.[Description], t.[Description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Collaborators], s.[Collaborators]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[CM_comment], s.[CM_comment]),
                        NULLIF(s.[CM_comment], t.[CM_comment])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Technical_Lead], s.[CM_Technical_Lead]),
                        NULLIF(s.[CM_Technical_Lead], t.[CM_Technical_Lead])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Description], s.[CM_Description]),
                        NULLIF(s.[CM_Description], t.[CM_Description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_External_Links], s.[CM_External_Links]),
                        NULLIF(s.[CM_External_Links], t.[CM_External_Links])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Team_Members], s.[CM_Team_Members]),
                        NULLIF(s.[CM_Team_Members], t.[CM_Team_Members])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_EPR_List], s.[CM_EPR_List]),
                        NULLIF(s.[CM_EPR_List], t.[CM_EPR_List])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_EUS_Proposal_List], s.[CM_EUS_Proposal_List]),
                        NULLIF(s.[CM_EUS_Proposal_List], t.[CM_EUS_Proposal_List])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Organisms], s.[CM_Organisms]),
                        NULLIF(s.[CM_Organisms], t.[CM_Organisms])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Experiment_Prefixes], s.[CM_Experiment_Prefixes]),
                        NULLIF(s.[CM_Experiment_Prefixes], t.[CM_Experiment_Prefixes])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Research_Team], s.[CM_Research_Team]),
                        NULLIF(s.[CM_Research_Team], t.[CM_Research_Team])) IS NOT NULL OR
                Coalesce( NULLIF(t.[CM_Fraction_EMSL_Funded], s.[CM_Fraction_EMSL_Funded]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Data_Package_Count], s.[Data_Package_Count]),
                        NULLIF(s.[Data_Package_Count], t.[Data_Package_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Cell_Culture_Most_Recent], s.[Cell_Culture_Most_Recent]),
                        NULLIF(s.[Cell_Culture_Most_Recent], t.[Cell_Culture_Most_Recent])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Experiment_Most_Recent], s.[Experiment_Most_Recent]),
                        NULLIF(s.[Experiment_Most_Recent], t.[Experiment_Most_Recent])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Dataset_Most_Recent], s.[Dataset_Most_Recent]),
                        NULLIF(s.[Dataset_Most_Recent], t.[Dataset_Most_Recent])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Job_Most_Recent], s.[Job_Most_Recent]),
                        NULLIF(s.[Job_Most_Recent], t.[Job_Most_Recent])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Run_Request_Most_Recent], s.[Run_Request_Most_Recent]),
                        NULLIF(s.[Run_Request_Most_Recent], t.[Run_Request_Most_Recent])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Sample_Prep_Request_Most_Recent], s.[Sample_Prep_Request_Most_Recent]),
                        NULLIF(s.[Sample_Prep_Request_Most_Recent], t.[Sample_Prep_Request_Most_Recent])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Most_Recent_Activity], s.[Most_Recent_Activity]),
    ...
    Begin -- <ChargeCodesAndEUS>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[NAME_FM], s.[NAME_FM]),
                        NULLIF(s.[NAME_FM], t.[NAME_FM])) IS NOT NULL OR
                Coalesce( NULLIF(t.[HID], s.[HID]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Title], s.[Title]),
                        NULLIF(s.[Title], t.[Title])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Proposal_Type], s.[Proposal_Type]),
                        NULLIF(s.[Proposal_Type], t.[Proposal_Type])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Proposal_Start_Date], s.[Proposal_Start_Date]),
                        NULLIF(s.[Proposal_Start_Date], t.[Proposal_Start_Date])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Proposal_End_Date], s.[Proposal_End_Date]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                Coalesce( NULLIF(t.[EUS_Display_Name], s.[EUS_Display_Name]),
                        NULLIF(s.[EUS_Display_Name], t.[EUS_Display_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[EUS_Instrument_Name], s.[EUS_Instrument_Name]),
                        NULLIF(s.[EUS_Instrument_Name], t.[EUS_Instrument_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[EUS_Available_Hours], s.[EUS_Available_Hours]),
                        NULLIF(s.[EUS_Available_Hours], t.[EUS_Available_Hours])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Local_Category_Name], s.[Local_Category_Name]),
                        NULLIF(s.[Local_Category_Name], t.[Local_Category_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Local_Instrument_Name], s.[Local_Instrument_Name]),
                ...
                Coalesce( NULLIF(t.[EUS_Active_Sw], s.[EUS_Active_Sw]),
                        NULLIF(s.[EUS_Active_Sw], t.[EUS_Active_Sw])) IS NOT NULL OR
                Coalesce( NULLIF(t.[EUS_Primary_Instrument], s.[EUS_Primary_Instrument]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                Coalesce( NULLIF(t.[Allocated_Hours], s.[Allocated_Hours]),
                        NULLIF(s.[Allocated_Hours], t.[Allocated_Hours])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Ext_Display_Name], s.[Ext_Display_Name]),
                        NULLIF(s.[Ext_Display_Name], t.[Ext_Display_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Ext_Requested_Hours], s.[Ext_Requested_Hours]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Fiscal_Year], s.[Fiscal_Year]),
                        NULLIF(s.[Fiscal_Year], t.[Fiscal_Year])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Allocated_Hours_Old], s.[Allocated_Hours_Old]),
                        NULLIF(s.[Allocated_Hours_Old], t.[Allocated_Hours_Old])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Allocated_Hours_New], s.[Allocated_Hours_New]),
                        NULLIF(s.[Allocated_Hours_New], t.[Allocated_Hours_New])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Comment], s.[Comment]),
                        NULLIF(s.[Comment], t.[Comment])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Entered], s.[Entered]),
                        NULLIF(s.[Entered], t.[Entered])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Entered_By], s.[Entered_By]),
                        NULLIF(s.[Entered_By], t.[Entered_By])) IS NOT NULL
                )
            THEN UPDATE SET
                [Allocation_Tag] = s.[Allocation_Tag],
    ...
    Begin -- <Experiments>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[P1], s.[P1]),
                        NULLIF(s.[P1], t.[P1])) IS NOT NULL OR
                Coalesce( NULLIF(t.[P1_Exception], s.[P1_Exception]),
                        NULLIF(s.[P1_Exception], t.[P1_Exception])) IS NOT NULL OR
                Coalesce( NULLIF(t.[P2], s.[P2]),
                        NULLIF(s.[P2], t.[P2])) IS NOT NULL OR
                Coalesce( NULLIF(t.[P2_Exception], s.[P2_Exception]),
                        NULLIF(s.[P2_Exception], t.[P2_Exception])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Sequest_Enzyme_Index], s.[Sequest_Enzyme_Index]),
                        NULLIF(s.[Sequest_Enzyme_Index], t.[Sequest_Enzyme_Index])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Protein_Collection_Name], s.[Protein_Collection_Name]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Experiment_Group_Item_Count], s.[Experiment_Group_Item_Count]),
                        NULLIF(s.[Experiment_Group_Item_Count], t.[Experiment_Group_Item_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Material_Containers_Item_Count], s.[Material_Containers_Item_Count]),
                        NULLIF(s.[Material_Containers_Item_Count], t.[Material_Containers_Item_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Requested_Run_Item_Count], s.[Requested_Run_Item_Count]),
                        NULLIF(s.[Requested_Run_Item_Count], t.[Requested_Run_Item_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Dataset_Item_Count], s.[Dataset_Item_Count]),
                        NULLIF(s.[Dataset_Item_Count], t.[Dataset_Item_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[HPLC_Runs_Item_Count], s.[HPLC_Runs_Item_Count]),
                        NULLIF(s.[HPLC_Runs_Item_Count], t.[HPLC_Runs_Item_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Total_Item_Count], s.[Total_Item_Count]),
                        NULLIF(s.[Total_Item_Count], t.[Total_Item_Count])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Material_Container_List], s.[Material_Container_List]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
             ...
             t.[Created] <> s.[Created] OR
                Coalesce( NULLIF(t.[Container_List], s.[Container_List]),
                        NULLIF(s.[Container_List], t.[Container_List])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Description], s.[Description]),
                        NULLIF(s.[Description], t.[Description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Storage_Path], s.[Storage_Path]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Description], s.[Description]),
                        NULLIF(s.[Description], t.[Description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[PubChem_CID], s.[PubChem_CID]),
                        NULLIF(s.[PubChem_CID], t.[PubChem_CID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Contact_PRN], s.[Contact_PRN]),
                        NULLIF(s.[Contact_PRN], t.[Contact_PRN])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Supplier], s.[Supplier]),
                        NULLIF(s.[Supplier], t.[Supplier])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Product_ID], s.[Product_ID]),
                        NULLIF(s.[Product_ID], t.[Product_ID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Purchase_Date], s.[Purchase_Date]),
                        NULLIF(s.[Purchase_Date], t.[Purchase_Date])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Purity], s.[Purity]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Cell_Culture_List], s.[Cell_Culture_List]),
                        NULLIF(s.[Cell_Culture_List], t.[Cell_Culture_List])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Reference_Compound_List], s.[Reference_Compound_List]),
    ...
    Begin -- <Datasets>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[SC_Comment], s.[SC_Comment]),
                        NULLIF(s.[SC_Comment], t.[SC_Comment])) IS NOT NULL OR
                Coalesce( NULLIF(t.[SC_Created], s.[SC_Created]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Cart_Description], s.[Cart_Description]),
        ...
        Begin
            ...
            -- Delete using delete_old_data_experiments_jobs_and_logs
            -- WHEN NOT MATCHED BY SOURCE And @DeleteExtras <> 0 THEN DELETE
            OUTPUT @tableName, $action,
        ...
        Begin
            ...
            ON ( t.[Dataset_ID] = s.[Dataset_ID])
            WHEN MATCHED AND (
                Coalesce( NULLIF(t.[SMAQC_Job], s.[SMAQC_Job]),
                        NULLIF(s.[SMAQC_Job], t.[SMAQC_Job])) IS NOT NULL OR
                Coalesce( NULLIF(t.[PSM_Source_Job], s.[PSM_Source_Job]),
                        NULLIF(s.[PSM_Source_Job], t.[PSM_Source_Job])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Last_Affected], s.[Last_Affected]),
                     NULLIF(s.[Last_Affected], t.[Last_Affected])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Quameter_Job], s.[Quameter_Job]),
                        NULLIF(s.[Quameter_Job], t.[Quameter_Job])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Quameter_Last_Affected], s.[Quameter_Last_Affected]),
                        NULLIF(s.[Quameter_Last_Affected], t.[Quameter_Last_Affected])) IS NOT NULL OR
                Coalesce( NULLIF(t.[QCDM_Last_Affected], s.[QCDM_Last_Affected]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Note], s.[Note]),
                        NULLIF(s.[Note], t.[Note])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AP_Server_Name], s.[AP_Server_Name]),
                        NULLIF(s.[AP_Server_Name], t.[AP_Server_Name])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AP_network_share_path], s.[AP_network_share_path]),
                        NULLIF(s.[AP_network_share_path], t.[AP_network_share_path])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AP_archive_URL], s.[AP_archive_URL]),
                        NULLIF(s.[AP_archive_URL], t.[AP_archive_URL])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AP_created], s.[AP_created]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[AS_state_Last_Affected], s.[AS_state_Last_Affected]),
                        NULLIF(s.[AS_state_Last_Affected], t.[AS_state_Last_Affected])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_datetime], s.[AS_datetime]),
                        NULLIF(s.[AS_datetime], t.[AS_datetime])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_last_update], s.[AS_last_update]),
                        NULLIF(s.[AS_last_update], t.[AS_last_update])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_last_verify], s.[AS_last_verify]),
                        NULLIF(s.[AS_last_verify], t.[AS_last_verify])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_update_state_ID], s.[AS_update_state_ID]),
                        NULLIF(s.[AS_update_state_ID], t.[AS_update_state_ID])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_update_state_Last_Affected], s.[AS_update_state_Last_Affected]),
                        NULLIF(s.[AS_update_state_Last_Affected], t.[AS_update_state_Last_Affected])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_purge_holdoff_date], s.[AS_purge_holdoff_date]),
                        NULLIF(s.[AS_purge_holdoff_date], t.[AS_purge_holdoff_date])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_archive_processor], s.[AS_archive_processor]),
                        NULLIF(s.[AS_archive_processor], t.[AS_archive_processor])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_update_processor], s.[AS_update_processor]),
                        NULLIF(s.[AS_update_processor], t.[AS_update_processor])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_verification_processor], s.[AS_verification_processor]),
                        NULLIF(s.[AS_verification_processor], t.[AS_verification_processor])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AS_Last_Successful_Archive], s.[AS_Last_Successful_Archive]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Last_Ordered], s.[Last_Ordered]),
                        NULLIF(s.[Last_Ordered], t.[Last_Ordered])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Requested_Batch_Priority], s.[Requested_Batch_Priority]),
                        NULLIF(s.[Requested_Batch_Priority], t.[Requested_Batch_Priority])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Actual_Batch_Priority], s.[Actual_Batch_Priority]),
                        NULLIF(s.[Actual_Batch_Priority], t.[Actual_Batch_Priority])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Requested_Completion_Date], s.[Requested_Completion_Date]),
                        NULLIF(s.[Requested_Completion_Date], t.[Requested_Completion_Date])) IS NOT NULL OR
                Coalesce( NULLIF(t.[Justification_for_High_Priority], s.[Justification_for_High_Priority]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                t.[RDS_Requestor_PRN] <> s.[RDS_Requestor_PRN] OR
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[QueueTime_0Days], s.[QueueTime_0Days]),
                        NULLIF(s.[QueueTime_0Days], t.[QueueTime_0Days])) IS NOT NULL OR
                Coalesce( NULLIF(t.[QueueTime_1to6Days], s.[QueueTime_1to6Days]),
               NULLIF(s.[QueueTime_1to6Days], t.[QueueTime_1to6Days])) IS NOT NULL OR
               Coalesce( NULLIF(t.[QueueTime_7to44Days], s.[QueueTime_7to44Days]),
                        NULLIF(s.[QueueTime_7to44Days], t.[QueueTime_7to44Days])) IS NOT NULL OR
                Coalesce( NULLIF(t.[QueueTime_45to89Days], s.[QueueTime_45to89Days]),
                        NULLIF(s.[QueueTime_45to89Days], t.[QueueTime_45to89Days])) IS NOT NULL OR
               Coalesce( NULLIF(t.[QueueTime_90to179Days], s.[QueueTime_90to179Days]),
                        NULLIF(s.[QueueTime_90to179Days], t.[QueueTime_90to179Days])) IS NOT NULL OR
                Coalesce( NULLIF(t.[QueueTime_180DaysAndUp], s.[QueueTime_180DaysAndUp]),
    ...
    Begin -- <Jobs>
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[AD_sequence], s.[AD_sequence]),
                        NULLIF(s.[AD_sequence], t.[AD_sequence])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AD_settingsFileName], s.[AD_settingsFileName]),
                        NULLIF(s.[AD_settingsFileName], t.[AD_settingsFileName])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AD_specialProcessing], s.[AD_specialProcessing]),
                        NULLIF(s.[AD_specialProcessing], t.[AD_specialProcessing])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AD_description], s.[AD_description]),
                        NULLIF(s.[AD_description], t.[AD_description])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AD_creator], s.[AD_creator]),
                        NULLIF(s.[AD_creator], t.[AD_creator])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AD_nextLevel], s.[AD_nextLevel]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                t.[AJR_settingsFileName] <> s.[AJR_settingsFileName] OR
                ...
                Coalesce( NULLIF(t.[AJR_organismDBName], s.[AJR_organismDBName]),
                        NULLIF(s.[AJR_organismDBName], t.[AJR_organismDBName])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJR_comment], s.[AJR_comment]),
                        NULLIF(s.[AJR_comment], t.[AJR_comment])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJR_workPackage], s.[AJR_workPackage]),
                        NULLIF(s.[AJR_workPackage], t.[AJR_workPackage])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJR_jobCount], s.[AJR_jobCount]),
                        NULLIF(s.[AJR_jobCount], t.[AJR_jobCount])) IS NOT NULL OR
                Coalesce( NULLIF(t.[AJR_specialProcessing], s.[AJR_specialProcessing]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                Coalesce( NULLIF(t.[Batch_Description], s.[Batch_Description]),
        ...
        Begin
            ...
            WHEN MATCHED AND (
                ...
                t.[AJ_settingsFileName] <> s.[AJ_settingsFileName] OR
...
GO
GRANT VIEW DEFINITION ON [dbo].[sync_with_dms5] TO [DDL_Viewer] AS [dbo]
GO
