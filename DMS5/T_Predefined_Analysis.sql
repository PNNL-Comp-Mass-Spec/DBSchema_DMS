...
CREATE TABLE [dbo].[T_Predefined_Analysis](
	...
	[AD_organismNameCriteria] [varchar](64) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_T_Predefined_Analysis_AD_organism_Name]  DEFAULT (''),
	...
	[AD_organismName] [varchar](64) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_T_Predefined_Analysis_AD_organismName]  DEFAULT ('default'),
	[AD_organismDBName] [varchar](64) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_T_Predefined_Analysis_AD_organismDBName]  DEFAULT ('default'),
