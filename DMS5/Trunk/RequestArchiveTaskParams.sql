/****** Object:  StoredProcedure [dbo].[RequestArchiveTaskParams] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE RequestArchiveTaskParams
/****************************************************
**
**	Desc: 
...
GO
GRANT VIEW DEFINITION ON [dbo].[RequestArchiveTaskParams] TO [Limited_Table_Write] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[RequestArchiveTaskParams] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[RequestArchiveTaskParams] TO [PNL\D3M580] AS [dbo]
GO
