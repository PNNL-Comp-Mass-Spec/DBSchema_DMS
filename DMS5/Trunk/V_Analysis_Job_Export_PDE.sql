...
AS
SELECT     
dbo.T_Analysis_Job.AJ_jobID AS Job, 
...
dbo.T_Dataset.DS_created AS DatasetCompleted, 
dbo.T_Analysis_Job.AJ_organismID AS OrganismID, 
dbo.T_Experiments.Exp_ID AS ExperimentID, 
dbo.T_Analysis_Job.AJ_batchID AS BatchNumber, 
