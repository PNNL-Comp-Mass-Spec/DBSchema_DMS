...
CREATE CLUSTERED INDEX [IX_T_MTS_MT_DB_Jobs_Cached_DBName_Job] ON [dbo].[T_MTS_MT_DB_Jobs_Cached] 
(
	[MT_DB_Name] ASC,
	[Job] ASC
...
INCLUDE ( [ResultType]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON, FILLFACTOR = 10) ON [PRIMARY]
GO
