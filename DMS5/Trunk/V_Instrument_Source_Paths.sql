...
FROM    T_Prep_Instruments AS TIN
        INNER JOIN T_Prep_Instrument_Storage AS TP ON TP.SP_instrument_name = TIN.Name
                                                      AND TP.SP_function = 'inbox'
GO
