...
SELECT     dbo.T_Analysis_Job.AJ_jobID AS Job, dbo.T_Analysis_Job.AJ_priority AS Priority, dbo.T_Dataset.Dataset_Num AS Dataset, 
                      ...
                      dbo.T_Organisms.OG_name AS Organism, dbo.T_Instrument_Name.IN_name AS InstrumentName, 
                      ...
                      dbo.T_Analysis_Job.AJ_resultsFolderName AS ResultsFolder, dbo.T_Analysis_Job.AJ_owner AS Owner, 
                      dbo.T_Analysis_Job.AJ_comment AS Comment, dbo.T_Dataset.DS_sec_sep AS SeparationSysType, 
                      dbo.T_Analysis_Tool.AJT_resultType AS ResultType, Dataset_Int_Std.Name AS [Dataset Int Std], dbo.T_Dataset.DS_created, 
                      dbo.T_Experiments.EX_enzyme_ID AS EnzymeID, dbo.T_Experiments.EX_Labelling AS Labelling, PreDigest_Int_Std.Name AS [PreDigest Int Std], 
