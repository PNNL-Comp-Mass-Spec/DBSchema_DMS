...
AS
SELECT     dbo.T_Analysis_Job_Processor_Group_Associations.Job_ID AS Job, dbo.T_Analysis_State_Name.AJS_name AS State, 
                      dbo.T_Dataset.Dataset_Num AS Dataset, dbo.T_Analysis_Tool.AJT_toolName AS Tool, dbo.T_Analysis_Job.AJ_parmFileName AS [Parm File], 
                      dbo.T_Analysis_Job.AJ_settingsFileName AS [Settings File], dbo.T_Analysis_Job_Processor_Group_Associations.Group_ID AS [#GroupID]
FROM         dbo.T_Analysis_Job_Processor_Group_Associations INNER JOIN
                      dbo.T_Analysis_Job ON dbo.T_Analysis_Job_Processor_Group_Associations.Job_ID = dbo.T_Analysis_Job.AJ_jobID INNER JOIN
