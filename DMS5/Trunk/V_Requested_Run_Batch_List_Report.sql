...
SELECT     dbo.T_Requested_Run_Batches.ID, dbo.T_Requested_Run_Batches.Batch AS Name, T.Requests, H.Runs, 
                      dbo.T_Requested_Run_Batches.Actual_Batch_Priority AS Priority, dbo.T_Requested_Run_Batches.Description, dbo.T_Users.U_Name AS Owner, 
                      dbo.T_Requested_Run_Batches.Created, dbo.T_Requested_Run_Batches.Locked, dbo.T_Requested_Run_Batches.Justification_for_High_Priority, 
