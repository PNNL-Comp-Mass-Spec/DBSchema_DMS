...
SELECT     dbo.T_Requested_Run_Batches.ID, dbo.T_Requested_Run_Batches.Batch AS Name, T.Requests, H.Runs, 
                      dbo.T_Requested_Run_Batches.Requested_Batch_Priority AS [Requested Priority], 
                      dbo.T_Requested_Run_Batches.Actual_Batch_Priority AS [Actual Priority], dbo.T_Requested_Run_Batches.Description, 
