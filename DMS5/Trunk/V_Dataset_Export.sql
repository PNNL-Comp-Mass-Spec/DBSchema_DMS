...
SELECT     dbo.T_Dataset.Dataset_Num AS Dataset, dbo.T_Experiments.Experiment_Num AS Experiment, dbo.T_Organisms.OG_name AS Organism, 
                      ...
                      dbo.T_Dataset.DS_Comp_State AS [Compressed State], dbo.T_Dataset.DS_Compress_Date AS [Compressed Date], dbo.T_Dataset.Dataset_ID AS ID, 
                      dbo.T_Dataset.Acq_Time_Start AS [Acquisition Start], dbo.T_Dataset.Acq_Time_End AS [Acquisition End], dbo.T_Dataset.Scan_Count AS [Scan Count], 
                      PreDigest_Int_Std.Name AS [PreDigest Int Std], PostDigest_Int_Std.Name AS [PostDigest Int Std]
