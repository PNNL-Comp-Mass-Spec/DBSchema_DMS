...
GO
GRANT DELETE ON [dbo].[T_Experiment_Annotations] TO [DMS_Annotation_User] AS [dbo]
GO
GRANT INSERT ON [dbo].[T_Experiment_Annotations] TO [DMS_Annotation_User] AS [dbo]
GO
GRANT UPDATE ON [dbo].[T_Experiment_Annotations] TO [DMS_Annotation_User] AS [dbo]
GO
...
GO
ALTER TABLE [dbo].[T_Experiment_Annotations] ADD  CONSTRAINT [DF_T_Experiment_Annotations_Entered]  DEFAULT (getdate()) FOR [Entered]
GO
ALTER TABLE [dbo].[T_Experiment_Annotations] ADD  CONSTRAINT [DF_T_Experiment_Annotations_Entered_By]  DEFAULT (suser_sname()) FOR [Entered_By]
GO
