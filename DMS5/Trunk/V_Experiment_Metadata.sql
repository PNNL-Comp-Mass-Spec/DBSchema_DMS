...
SELECT     dbo.T_Experiments.Experiment_Num AS Name, dbo.T_Experiments.Exp_ID AS ID, 
                      dbo.T_Users.U_Name + ' (' + dbo.T_Experiments.EX_researcher_PRN + ')' AS Researcher, dbo.T_Experiments.EX_organism_name AS Organism, 
...
FROM         dbo.T_Experiments INNER JOIN
                      ...
                      dbo.T_Experiments.EX_postdigest_internal_std_ID = T_Internal_Standards_1.Internal_Std_Mix_ID
