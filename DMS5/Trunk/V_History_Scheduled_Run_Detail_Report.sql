...
SELECT RRH.ID AS Request,
       ...
       dbo.T_Users.U_Name + ' (' + RRH.RDS_Oper_PRN + ')' AS Requestor,
...
FROM dbo.T_Requested_Run_History AS RRH
     ...
     INNER JOIN dbo.T_Users
       ON RRH.RDS_Oper_PRN = dbo.T_Users.U_PRN
     LEFT OUTER JOIN dbo.T_Attachments
       ON RRH.RDS_MRM_Attachment = dbo.T_Attachments.ID


GO
GRANT VIEW DEFINITION ON [dbo].[V_History_Scheduled_Run_Detail_Report] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_History_Scheduled_Run_Detail_Report] TO [PNL\D3M580] AS [dbo]
GO
