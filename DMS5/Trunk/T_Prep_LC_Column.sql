...
CREATE TABLE [dbo].[T_Prep_LC_Column](
	...
	[Packing_Mfg] [varchar](64) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_T_Prep_LC_Column_PC_Packing_Mfg]  DEFAULT ('na'),
	...
	[State] [varchar](32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_T_Prep_LC_Column_PC_State]  DEFAULT ('New'),
	...
	[Created] [datetime] NOT NULL CONSTRAINT [DF_T_Prep_LC_Column_Created]  DEFAULT (getdate()),
