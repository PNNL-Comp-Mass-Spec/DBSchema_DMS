...
( NAME = N'DMS4_dat', FILENAME = N'C:\DMS Database Files\DMS5_data.mdf' , SIZE = 312768KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
 LOG ON 
( NAME = N'DMS4_log', FILENAME = N'C:\DMS Database Files\DMS5_log.ldf' , SIZE = 25920KB , MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
