...
CREATE TABLE [dbo].[T_Predefined_Analysis_Scheduling_Rules](
	...
	[SR_processorName] [varchar](64) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_T_Predefined_Analysis_Scheduling_Rules_SR_processorName]  DEFAULT (''),
