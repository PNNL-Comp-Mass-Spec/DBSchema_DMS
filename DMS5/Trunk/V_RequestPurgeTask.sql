...
SELECT     dbo.T_Dataset.Dataset_Num AS dataset, dbo.T_Dataset.DS_folder_name AS Folder, 
                      dbo.ConvertFtpArchivePathToSamba(dbo.T_Archive_Path.AP_archive_path) + '\' AS SambaStoragePath, 
                      dbo.t_storage_path.SP_machine_name AS StorageServerName, dbo.T_Dataset.Dataset_ID AS DatasetID, 
