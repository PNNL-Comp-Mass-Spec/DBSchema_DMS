...
GO
CREATE VIEW V_Notification_Sample_Prep_Request_By_Research_Team AS
...
FROM
  ...
  INNER JOIN T_Sample_Prep_Request ON TNE.Target_ID = T_Sample_Prep_Request.ID
  INNER JOIN T_Sample_Prep_Request_State_Name ON T_Sample_Prep_Request.State = T_Sample_Prep_Request_State_Name.State_ID
  INNER JOIN ( SELECT
             ...
             ) AS T ON T.Campaign = T_Sample_Prep_Request.Campaign
WHERE
