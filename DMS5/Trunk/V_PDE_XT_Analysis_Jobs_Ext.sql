...
SELECT     dbo.T_Analysis_Job.AJ_jobID AS AnalysisID, dbo.T_Dataset.Dataset_Num AS DatasetName, dbo.T_Experiments.Experiment_Num AS Experiment, 
                      ...
                      dbo.T_Analysis_Job.AJ_parmFileName AS ParamFileUsed, dbo.T_Experiments.EX_organism_name AS Organism, 
                      ...
                      dbo.t_storage_path.SP_vol_name_client + dbo.t_storage_path.SP_path + dbo.T_Dataset.DS_folder_name + '\' + dbo.T_Analysis_Job.AJ_resultsFolderName
                       + '\' AS AnalysisJobPath, dbo.T_Instrument_Name.IN_name AS InstrumentName
...
WHERE     (dbo.T_Analysis_Job.AJ_StateID = 4) AND (dbo.T_Analysis_Tool.AJT_toolName LIKE '%xtandem%')
