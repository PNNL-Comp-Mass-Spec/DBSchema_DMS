...
SELECT     T_Sample_Prep_Request.Request_Name AS RequestName, T_Sample_Prep_Request.Requester_PRN AS RequesterPRN, 
                      ...
                      T_Sample_Prep_Request.Replicates_of_Samples AS ReplicatesofSamples, T_Sample_Prep_Request.Instrument_Name AS InstrumentName, 
                      T_Sample_Prep_Request.Technical_Replicates AS TechnicalReplicates, T_Sample_Prep_Request.Dataset_Type AS DatasetType, 
                      ...
                      T_Sample_Prep_Request.EUS_User_List AS eusUsersList, T_Sample_Prep_Request.Project_Number AS ProjectNumber, 
                      T_Sample_Prep_Request.Facility
FROM         T_Sample_Prep_Request INNER JOIN
                      ...
                      T_Sample_Prep_Request.Postdigest_internal_std_ID = T_Internal_Standards_1.Internal_Std_Mix_ID  
