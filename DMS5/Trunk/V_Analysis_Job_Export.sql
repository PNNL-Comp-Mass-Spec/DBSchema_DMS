...
SELECT     dbo.T_Analysis_Job.AJ_jobID AS Job, dbo.T_Dataset.Dataset_Num AS Dataset, dbo.T_Experiments.Experiment_Num AS Experiment, 
                      ...
                      dbo.T_Instrument_Name.IN_name AS InstrumentName, dbo.T_Instrument_Name.IN_class AS InstrumentClass, 
                      ...
                      dbo.T_Dataset.DS_sec_sep AS SeparationSysType, dbo.T_Analysis_Tool.AJT_resultType AS ResultType, dbo.T_Dataset.DS_created, 
