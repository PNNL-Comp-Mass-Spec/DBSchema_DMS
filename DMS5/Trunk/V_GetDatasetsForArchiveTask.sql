...
SELECT     TD.Dataset_Num AS Dataset, TD.Dataset_ID, TD.DS_folder_name AS Folder, dbo.t_storage_path.SP_machine_name AS Storage_Server_Name, 
                      ...
                      dbo.T_Archive_Path.AP_Server_Name AS Archive_Server, dbo.T_Archive_Path.AP_archive_path AS Archive_Path, 
                      dbo.T_Archive_Path.AP_network_share_path AS Archive_Network_Share_Path, dbo.T_Instrument_Name.IN_class AS Instrument_Class, 
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_GetDatasetsForArchiveTask] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_GetDatasetsForArchiveTask] TO [PNL\D3M580] AS [dbo]
GO
