...
GO
CREATE PROCEDURE [dbo].[RequestDataExtractionTaskParams]
/****************************************************
**
**	Desc: 
...
GO
GRANT VIEW DEFINITION ON [dbo].[RequestDataExtractionTaskParams] TO [Limited_Table_Write] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[RequestDataExtractionTaskParams] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[RequestDataExtractionTaskParams] TO [PNL\D3M580] AS [dbo]
GO
