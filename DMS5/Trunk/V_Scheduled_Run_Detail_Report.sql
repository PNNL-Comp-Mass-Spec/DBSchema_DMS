...
GO
CREATE VIEW dbo.V_Scheduled_Run_Detail_Report
AS
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_Scheduled_Run_Detail_Report] TO [PNL\D3M578] AS [dbo]
GO
GRANT VIEW DEFINITION ON [dbo].[V_Scheduled_Run_Detail_Report] TO [PNL\D3M580] AS [dbo]
GO
