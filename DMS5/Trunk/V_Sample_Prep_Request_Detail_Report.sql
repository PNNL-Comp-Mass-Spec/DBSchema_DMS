...
SELECT     dbo.T_Sample_Prep_Request.ID, dbo.T_Sample_Prep_Request.Request_Name AS [Request Name], 
                      ...
                      dbo.T_Sample_Prep_Request.Prep_By_Robot AS [Prep By Robot], dbo.T_Sample_Prep_Request.Special_Instructions AS [Special Instructions], 
                      dbo.T_Sample_Prep_Request.UseSingleLCColumn, dbo.T_Internal_Standards.Name AS [Predigest Int Std], 
                      T_Internal_Standards_1.Name AS [Postdigest Int Std], dbo.T_Sample_Prep_Request.Sample_Naming_Convention AS [Sample Group Naming Prefix], 
