/****** Object:  View [dbo].[V_Protein_Collection_Detail_Report] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[V_Protein_Collection_Detail_Report]
AS
SELECT LookupQ.id,
       LookupQ.name,
       CASE
       ...
       LookupQ.state + '; ' + LookupQ.state_description AS state,
       LookupQ.entries,
       LookupQ.residues,
       CASE
...
GROUP BY LookupQ.ID, LookupQ.Name, LookupQ.Description, LookupQ.Organism_Name,
         LookupQ.State, LookupQ.State_Description, LookupQ.Entries, LookupQ.Residues,
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_Protein_Collection_Detail_Report] TO [DDL_Viewer] AS [dbo]
GO
