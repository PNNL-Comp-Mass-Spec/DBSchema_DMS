...
SELECT AJ.AJ_jobID AS Job,
       ...
       dbo.combine_paths(SP.SP_vol_name_client, SP.SP_path) AS StoragePathServer,
...
GO
GRANT VIEW DEFINITION ON [dbo].[V_Analysis_Job_Export_Storage_Path] TO [DDL_Viewer] AS [dbo]
GO
